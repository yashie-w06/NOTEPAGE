(() => {
  ...
  function exportHtml(){
    ...
    const page=`<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>${escapedTitle}</title><style>:root{color-scheme:dark}*{box-sizing:border-box}html{scroll-behavior:smooth}body{max-width:1200px;margin:40px auto;padding:0 24px;background:#050505;color:#ccc;font:16px/1.5 "Courier New",monospace}.note-title{color:#fff;text-align:center}.export-layout{display:grid;grid-template-columns:minmax(0,1fr) 280px;gap:32px;align-items:start}[data-dos-note-content]{min-width:0;grid-column:1;grid-row:1}.toc-panel{position:sticky;top:24px;grid-column:2;grid-row:1;border:1px solid #777;background:#090909}.toc-panel h2{margin:0;padding:10px;background:#00aaaa;color:#000;font-size:1rem}.export-toc{padding:10px}.export-toc a{display:block;padding:5px;color:#5ff;text-decoration:none}.export-toc .level-2{padding-left:22px}.export-toc .level-3{padding-left:40px;color:#ff5}.export-toc span{color:#777}h1,h2,h3{color:#fff;scroll-margin-top:24px}a{color:#5ff}img{max-width:100%;height:auto}pre,blockquote{white-space:pre-wrap;overflow-wrap:anywhere;background:#111;padding:12px;border-left:5px solid #aaa}@media(max-width:760px){.export-layout{display:flex;flex-direction:column}.toc-panel{position:relative;top:0;width:100%;order:-1}}@media print{body{max-width:none;margin:0;background:#fff;color:#000}.export-layout{display:block}.toc-panel{position:relative;margin-bottom:24px;background:#fff;break-after:page}.toc-panel h2{background:#ddd}h1,h2,h3{color:#000}.export-toc a{color:#000}}</style></head><body><header><h1 class="note-title">${escapedTitle}</h1></header><div class="export-layout">${cloned.outerHTML}<aside class="toc-panel"><h2>TABLE OF CONTENTS</h2>${exportedToc.outerHTML}</aside></div></body></html>`;
